...
useEffect(() => {
  if (activeTab === 'intelligence') {
    ...
    // Check available credits if organization name exists
    if (editedDeal.organization_name) {
          ...
          {!companyIntelligence && !isGeneratingIntelligence && (
            <button
              ...
              title={!editedDeal.organization_name 
                ...
                : `Generate report (requires 1 credit, you have ${availableCredits})`
              }
            >
              ...
              <div className="flex flex-col sm:flex-row sm:items-start justify-between mb-4 sm:mb-6 gap-3">
                ...
                <div className="text-right">
                  <div className={`text-2xl sm:text-3xl font-bold mb-1 ${
                    companyIntelligence.json.scorecard.final_percentage >= 80
                      ? 'text-green-500' :
                  ...
                  <span className={`text-xs sm:text-sm px-2 py-1 sm:px-3 sm:py-1 rounded-full font-medium ${
                    companyIntelligence.json.scorecard.final_percentage >= 80
                  ...
                  <div className="relative w-24 h-24 sm:w-32 sm:h-32">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center">
                        <span className={`text-2xl sm:text-4xl font-bold block ${
                          companyIntelligence.json.scorecard.final_percentage >= 80 ? 'text-green-500' :
          ...
          {companyIntelligence.json?.identity_and_overview && (
            <div className={`rounded-lg border ${
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-3 sm:mb-4 gap-2">
                ...
                <span className={`text-base sm:text-xl px-2 py-1 sm:px-3 sm:py-2 rounded-full font-semibold ${
