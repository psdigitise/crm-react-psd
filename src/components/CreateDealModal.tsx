...
//     // Annual Revenue validation - Added this validation
//     if (formData.annual_revenue && formData.annual_revenue.length > 10) {
//       newErrors.annual_revenue = 'Annual Revenue cannot exceed 10 characters';
//     }
...
//                     />
//                     {/* Show character count and error message */}
//                     <div className="flex justify-between mt-1">
//                       <div>
//                         {errors.annual_revenue && (
//                           <p className="text-sm text-red-500">{errors.annual_revenue}</p>
//                         )}
//                       </div>
//                       <div>
//                         <span className={`text-xs ${
//                           formData.annual_revenue.length > 10 
//                             ? 'text-red-500' 
//                             : theme === 'dark' 
//                               ? 'text-gray-400' 
//                               : 'text-gray-500'
