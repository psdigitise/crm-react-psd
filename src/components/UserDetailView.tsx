...
//   const handleDelete = () => {
//     showToast('Are you sure you want to delete this user?', {
//       type: 'warning',
//       duration: 0,
//       actions: [
//         {
...
//             <div className={`rounded-lg shadow-sm border p-6 backdrop-blur-md ${
//               theme === 'dark' 
...
//                   theme === 'dark' ? 'bg-purplebg' : 'bg-gray-200'
//                 }`}>
...
//                     <p className={`text-sm ${theme === 'dark' ? 'text-white' : 'text-gray-600'}`}>{user.email}</p>
//                   </div>
//                 </div>
...
//                     <p className={`text-sm ${theme === 'dark' ? 'text-white' : 'text-gray-600'}`}>{user.company || 'N/A'}</p>
//                   </div>
//                 </div>
...
//                     <p className={`text-sm ${theme === 'dark' ? 'text-white' : 'text-gray-600'}`}>{user.role_profile_name || 'N/A'}</p>
//                   </div>
//                 </div>
...
//                     <p className={`text-sm ${theme === 'dark' ? 'text-white' : 'text-gray-600'}`}>{formatDate(user.creation)}</p>
//                   </div>
//                 </div>
//               </div>
//             </div>
