    ...
    <div className={`${
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center space-x-2 overflow-x-auto">
            ...
            {/* <button
              ...
              className={`p-2 rounded-lg transition-colors flex items-center space-x-1 ${
                activeFiltersCount > 0 
                  ? theme === 'dark' ? 'bg-purplebg/30 text-purple-300' : 'bg-blue-50 text-blue-700'
                  : theme === 'dark' 
                    ? 'text-white hover:text-white hover:bg-purple-800/50' 
                    : 'text-gray-500 hover:text-gray-700 hover:bg-gray-100'
              }`}
          ...
          {/* <button
            onClick={onSort}
            className={`p-2 rounded-lg transition-colors flex items-center space-x-1 flex-shrink-0 ${
              theme === 'dark' 
                ? 'text-white hover:text-white hover:bg-purple-800/50' 
                : 'text-gray-500 hover:text-gray-700 hover:bg-gray-100'
            }`}
          ...
          <div className="relative flex-shrink-0">
            ...
            >
              ...
              <span className="text-sm hidden lg:inline">Columns</span>
            </button> */}
