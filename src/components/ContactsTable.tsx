...
//   searchTerm: string;
//   onContactClick?: (contact: Contact) => void;
//   refreshTrigger?: number; // Add this prop to trigger refreshes from parent
// }
...
// export function ContactsTable({ searchTerm, onContactClick, refreshTrigger = 0 }: ContactsTableProps) {
//   const { theme } = useTheme();
//   const [contacts, setContacts] = useState<Contact[]>([]);
//   const [loading, setLoading] = useState(true);
//   const [error, setError] = useState<string | null>(null);
...
//   // Remove the softRefreshContacts function and interval as it's causing too many API calls
