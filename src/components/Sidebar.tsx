...
// //                 <div className={`w-8 h-8 ${theme === 'dark' ? 'bg-purplebg' : 'bg-blue-600'} rounded-lg flex items-center justify-center`}>
// //                   <span className="text-white font-bold text-sm">P</span>
// //                 </div>
// //                 <div>
// //                   <h2 className={`font-semibold text-sm ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>
// //                     PSDigitise
// //                   </h2>
// //                   <p className={`text-xs ${theme === 'dark' ? 'text-white' : 'text-gray-500'}`}>
// //                     {userSession?.full_name || userSession?.username || 'Administrator'}
// //                   </p>
// //                 </div>
// //               </div>
// //             )}
...
// //                       }
// //                     }}
// //                     className={`w-full flex items-center space-x-3 px-3 py-2.5 rounded-lg transition-all duration-200 relative ${isActive
// //                         ? theme === 'dark'
// //                           ? 'bg-purplebg/30 text-purple-300 border border-purple-500/50'
// //                           : 'bg-blue-50 text-blue-700 border border-blue-200'
// //                         : theme === 'dark'
// //                           ? 'text-white hover:bg-purple-800/30 hover:text-white'
// //                           : 'text-gray-700 hover:bg-gray-50 hover:text-gray-900'
// //                       }`}
// //                   >
// //                     <Icon
// //                       className={`w-5 h-5 flex-shrink-0 ${isActive
// //                           ? theme === 'dark' ? 'bg-purplebg' : 'text-blue-600'
// //                           : theme === 'dark'
...
// //                   {isCollapsed && (
// //                     <div className="absolute left-full ml-2 px-2 py-1 bg-gray-900 text-white text-xs rounded opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 whitespace-nowrap pointer-events-none">
// //                       {item.label}
// //                       {showNotificationBadge && (
...
// //             <div className={`mb-3 p-3 rounded-lg ${theme === 'dark' ? 'bg-purple-800/20' : 'bg-gray-50'
// //               }`}>
// //               <div className={`text-sm font-medium ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>
// //                 {userSession.full_name || userSession.username}
// //               </div>
...
// //               theme === 'dark' ? 'bg-purple-800/20' : 'bg-gray-50'
// //             }`}>
// //               <div className={`text-sm font-medium ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>
// //                 {userSession.full_name || userSession.username}
// //               </div>
...
//                       }
//                     }}
//                     className={`w-full flex items-center space-x-3 px-3 py-2.5 my-2 rounded-lg transition-all duration-200 relative ${
//                       isActive
//                         ? theme === 'dark'
//                           ? 'bg-[#ffffff7a] text-purple-300 border border-0'
//                           : 'bg-blue-50 text-blue-700 border border-blue-200'
...
//                     {/* Notification Badge */}
//                     {showNotificationBadge && (
//                       <span className="absolute -top-1 -right-1 bg-red-500 text-white text-sm font-semibold rounded-full w-5 h-5 flex items-center justify-center font-bold">
//                         {unreadCount > 99 ? '99+' : unreadCount}
//                       </span>
//                     )}
//                   </button>
