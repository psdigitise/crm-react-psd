...
interface DeleteDealPopupProps {
  isOpen: boolean;
  onClose: () => void;
  theme?: 'light' | 'dark';
  onConfirm: () => void;
...
export const DeleteDealPopup: React.FC<DeleteDealPopupProps> = ({
  isOpen,
  onClose,
  theme = 'dark',
  onConfirm,
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto">
      ...
      {/* Modal Content */}
      <div 
        className={`relative border border-gray-800 transform overflow-hidden rounded-lg text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg ${
