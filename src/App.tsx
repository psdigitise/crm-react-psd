...
//   //   if (createModalType === 'lead') {
//   //     setLeads(prev => [...prev, data]);
//   //     setSelectedLead(data); // This will open the detail view
//   //     setShowCreateModal(false);
//   //     window.history.pushState({}, '', `/leads/${data.id}`); // Update URL
//   //     setActiveMenuItem('leads');
//   //   }
...
// //   // New function to handle deal clicks from ContactDetails
// //   const handleDealClickFromContact = async (dealName: string) => {
// //     try {
// //       // You'll need to fetch the deal details using the dealName
// //       const session = getUserSession();
// //       if (!session) {
...
// //       // Example API call to get deal details
// //       const apiUrl = 'http://103.214.132.20:8002/api/method/crm.api.deal.get_deal';
...
// //       if (dealData) {
// //         // Transform the deal data to match your Deal interface
// //         const transformedDeal = {
// //           id: dealData.name,
// //           name: dealData.name || dealName,
...
// //           email: dealData.email || dealData.email_id || 'No email',
// //           mobile_no: dealData.mobile_no || dealData.phone || 'No phone',
// //           deal_owner: dealData.deal_owner || dealData.owner || 'Unassigned',
// //           modified: dealData.modified || '',
// //           // Add other required fields based on your Deal interface
// //           ...dealData
// //         };

// //         setSelectedDeal(transformedDeal);
// //         setActiveMenuItem('deals');
// //         window.history.pushState({}, '', `/deals/${dealData.name}`);
// //       }
// //     } catch (error) {
// //       console.error('Error fetching deal details:', error);
// //       showToast('Failed to fetch deal details', { type: 'error' });
      
// //       // Fallback: try to find deal in sampleDeals if API fails
// //       const fallbackDeal = sampleDeals.find(d => d.id === dealName || d.name === dealName);
// //       if (fallbackDeal) {
// //         setSelectedDeal(fallbackDeal);
// //         setActiveMenuItem('deals');
// //         window.history.pushState({}, '', `/deals/${fallbackDeal.id}`);
// //       }
// //     }
// //   };
